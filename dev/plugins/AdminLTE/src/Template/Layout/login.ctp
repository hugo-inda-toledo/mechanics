...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $this->Url->build(array('controller' => 'Pages', 'action' => 'index', 'prefix'=>false)); ?>"><?php echo $theme['logo']['large'] ?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo __('Iniciar Sesión') ?></p>
...
<?php echo $this->fetch('content'); ?>
    ...
    if (isset($theme['login']['show_remember']) && $theme['login']['show_remember']) {
        ?>
        <a href="<?php echo $this->Url->build(array('controller' => 'Users', 'action' => 'forgottenPassword', 'prefix'=>'admin')); ?>"><?php echo __('Olvidé mi contraseña') ?></a><br>
        <?php
    }
