        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                                                                                                        <dt><?= __('Bank') ?></dt>
                                <dd>
                                    <?= $paymentRefund->has('bank') ? $paymentRefund->bank->id : '' ?>
                                </dd>
                                                                                                                        <dt><?= __('Name') ?></dt>
                                        <dd>
                                            <?= h($paymentRefund->name) ?>
                                        </dd>
                                                                                                                                                            <dt><?= __('Email') ?></dt>
                                        <dd>
                                            <?= h($paymentRefund->email) ?>
                                        </dd>
                                                                                                                                    
                                            
                                                                                                                                                            <dt><?= __('Account Number') ?></dt>
                                <dd>
                                    <?= $this->Number->format($paymentRefund->account_number) ?>
                                </dd>
                                                                                                                <dt><?= __('Dni') ?></dt>
                                <dd>
                                    <?= $this->Number->format($paymentRefund->dni) ?>
                                </dd>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($paymentRefund->providers)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($paymentRefund->providers as $providers): ?>
                                <tr>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <?php if (!empty($paymentRefund->users)): ?>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <?php foreach ($paymentRefund->users as $users): ?>
                                <tr>
