<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Exportar Pagos a Proveedores</li>
    </ol> 
</section>
...
<section class="content">
  <div class="box">
    ...
    <div class="box-body">
      <?= $this->Form->create(null, ['url' => ['controller' => 'Providers', 'action' => 'getExcelData', '_ext'=>'xlsx']]);?>
      ...
      <div class="form-group">
        <label>Selecciona el banco con el que vas a pagar:</label>
        <?= $this->Form->select('bank_id', $banks, ['class' => 'form-control', 'required' => true, 'label' => false, 'empty' => 'Selecciona un banco']);?>
      </div>
