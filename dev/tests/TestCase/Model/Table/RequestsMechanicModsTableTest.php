...
use App\Model\Table\RequestsMechanicModsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequestsMechanicModsTable Test Case
 */
class RequestsMechanicModsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequestsMechanicModsTable
     */
    public $RequestsMechanicMods;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequestsMechanicMods') ? [] : ['className' => 'App\Model\Table\RequestsMechanicModsTable'];
        $this->RequestsMechanicMods = TableRegistry::get('RequestsMechanicMods', $config);
    }
    ...
    {
        unset($this->RequestsMechanicMods);
