...
use App\Model\Table\PurchaseOrdersSuppliesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PurchaseOrdersSuppliesTable Test Case
 */
class PurchaseOrdersSuppliesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PurchaseOrdersSuppliesTable
     */
    public $PurchaseOrdersSupplies;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PurchaseOrdersSupplies') ? [] : ['className' => 'App\Model\Table\PurchaseOrdersSuppliesTable'];
        $this->PurchaseOrdersSupplies = TableRegistry::get('PurchaseOrdersSupplies', $config);
    }
    ...
    {
        unset($this->PurchaseOrdersSupplies);
