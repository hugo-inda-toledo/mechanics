...
use App\Model\Table\PurchaseOrdersItemsTable;
...
class PurchaseOrdersItemsTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\Model\Table\PurchaseOrdersItemsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PurchaseOrdersItems') ? [] : ['className' => 'App\Model\Table\PurchaseOrdersItemsTable'];
