...
use App\Model\Table\ScheduleLogsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ScheduleLogsTable Test Case
 */
class ScheduleLogsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ScheduleLogsTable
     */
    public $ScheduleLogs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ScheduleLogs') ? [] : ['className' => 'App\Model\Table\ScheduleLogsTable'];
        $this->ScheduleLogs = TableRegistry::get('ScheduleLogs', $config);
    }
