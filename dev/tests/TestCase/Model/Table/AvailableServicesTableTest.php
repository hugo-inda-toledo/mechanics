...
use App\Model\Table\AvailableServicesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AvailableServicesTable Test Case
 */
class AvailableServicesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AvailableServicesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AvailableServices') ? [] : ['className' => 'App\Model\Table\AvailableServicesTable'];
        $this->AvailableServices = TableRegistry::get('AvailableServices', $config);
    }
