...
class CommunesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'communes_ibfk_1' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2017-02-08 18:16:13',
            'modified' => '2017-02-08 18:16:13',
            'city_id' => 1
        ],
    ];
}
