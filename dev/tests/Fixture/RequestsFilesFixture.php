...
/**
 * RequestsFilesFixture
 *
 */
class RequestsFilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'requests_files_ibfk_1' => ['type' => 'foreign', 'columns' => ['request_id'], 'references' => ['requests', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'size' => 1,
            'active' => 1,
            'created' => '2017-02-03 19:44:41',
            'modified' => '2017-02-03 19:44:41'
        ],
    ];
}
