 ...
 *
 */
class PollTablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_tables_polls1_idx' => ['type' => 'index', 'columns' => ['poll_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_tables_polls1' => ['type' => 'foreign', 'columns' => ['poll_id'], 'references' => ['polls', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
