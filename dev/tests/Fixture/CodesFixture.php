...
class CodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'codes_ibfk_1' => ['type' => 'foreign', 'columns' => ['bank_id'], 'references' => ['banks', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'bank_id' => 1,
            'code' => 'Lorem ip',
            'created' => '2017-02-28 19:22:25',
            'modified' => '2017-02-28 19:22:25'
        ],
    ];
}
