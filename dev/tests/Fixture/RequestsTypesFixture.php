...
/**
 * RequestsTypesFixture
 *
 */
class RequestsTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'car_is_optional' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2017-02-03 19:09:34',
            'modified' => '2017-02-03 19:09:34',
            'car_is_optional' => 1
        ],
    ];
}
