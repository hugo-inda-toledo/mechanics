 ...
 *
 */
class CarModelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'car_models_ibfk_1' => ['type' => 'foreign', 'columns' => ['car_brand_id'], 'references' => ['car_brands', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2017-03-13 19:12:24',
            'modified' => '2017-03-13 19:12:24'
        ],
    ];
}
