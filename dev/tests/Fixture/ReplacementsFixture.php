...
class ReplacementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'original_price' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'price_for_request' => 1,
            'active' => 1,
            'created' => '2017-03-15 19:00:22',
            'modified' => '2017-03-15 19:00:22'
        ],
    ];
}
