...
class SuppliesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price_for_request' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'stock' => 1,
            'active' => 1,
            'created' => '2017-03-13 19:10:27',
            'modified' => '2017-03-13 19:10:27'
        ],
    ];
}
