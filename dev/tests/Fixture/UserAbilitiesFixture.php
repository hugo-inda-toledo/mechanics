...
/**
 * UserAbilitiesFixture
 *
 */
class UserAbilitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'user_abilities_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'user_abilities_ibfk_1' => ['type' => 'foreign', 'columns' => ['ability_id'], 'references' => ['abilities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2017-02-13 15:53:16',
            'modified' => '2017-02-13 15:53:16'
        ],
    ];
}
