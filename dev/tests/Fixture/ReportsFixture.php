...
class ReportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'reports_ibfk_2' => ['type' => 'foreign', 'columns' => ['request_id'], 'references' => ['requests', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'reports_ibfk_3' => ['type' => 'foreign', 'columns' => ['report_question_category_id'], 'references' => ['report_question_categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'total' => 1,
            'created' => '2017-02-24 17:08:45',
            'modified' => '2017-02-24 17:08:45'
        ],
    ];
}
