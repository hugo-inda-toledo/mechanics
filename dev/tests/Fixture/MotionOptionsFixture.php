...
/**
 * MotionOptionsFixture
 *
 */
class MotionOptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'motion_options_ibfk_1' => ['type' => 'foreign', 'columns' => ['consultation_id'], 'references' => ['consultations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-10-24 14:58:29',
            'modified' => '2016-10-24 14:58:29'
        ],
    ];
}
