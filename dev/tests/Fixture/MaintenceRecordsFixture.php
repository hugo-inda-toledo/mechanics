...
/**
 * MaintenceRecordsFixture
 *
 */
class MaintenceRecordsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'maintence_records_ibfk_1' => ['type' => 'foreign', 'columns' => ['car_id'], 'references' => ['cars', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'date' => '2017-02-09 12:49:51',
            'description' => 'Lorem ipsum dolor sit amet',
            'active' => 1,
            'created' => '2017-02-09 12:49:51',
            'modified' => '2017-02-09 12:49:51',
            'car_id' => 1
        ],
    ];
}
