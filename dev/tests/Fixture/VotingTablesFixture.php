 ...
 *
 */
class VotingTablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'voting_tables_ibfk_1' => ['type' => 'foreign', 'columns' => ['voting_table_group_id'], 'references' => ['voting_table_groups', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-10-24 14:58:34',
            'modified' => '2016-10-24 14:58:34'
        ],
    ];
}
