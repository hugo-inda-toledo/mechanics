...
class PurchaseOrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'purchase_orders_ibfk_1' => ['type' => 'foreign', 'columns' => ['request_id'], 'references' => ['requests', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'request_id' => 1,
            'active' => 1,
            'created' => '2017-03-14 20:45:42',
            'modified' => '2017-03-14 20:45:42'
        ],
    ];
}
